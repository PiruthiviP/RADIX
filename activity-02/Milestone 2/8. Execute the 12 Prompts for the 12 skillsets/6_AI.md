...
# Task
Generate the dictionary for the following Skill Set: AI Native Engineering(Ability of an Engineer to use AI tools to build software with high prototyping and high velocity)