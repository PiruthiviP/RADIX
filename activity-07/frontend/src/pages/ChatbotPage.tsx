...
export default function ChatbotPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hello! I am Antigravity, your Corporate Intelligence Copilot. Ask me anything about the companies in the RADIX database. I can perform semantic searches, provide competitor comparisons, summarize strategic metrics, or generate SWOT analysis reports.",
    }
  ]);
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)] max-w-5xl mx-auto p-4 font-sans">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-border mb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Antigravity Copilot</h1>
      ...
      >
        <input
          ...
          className="flex-1 px-4 py-3 rounded-xl border border-border bg-card text-sm focus:outline-none focus:ring-1 focus:ring-primary shadow-sm"
          disabled={loading}
        />
        <button
          type="submit"
